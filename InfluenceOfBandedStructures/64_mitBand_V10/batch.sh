...
cd /home/nf838244/IEHK/DAMASK3/Biegesimulationen/64_mitBand_V10
singularity exec /rwthfs/rz/SW/UTIL.common/singularity/damask-grid mpiexec -n 32 DAMASK_grid --load load.yaml --geom grid.vti
