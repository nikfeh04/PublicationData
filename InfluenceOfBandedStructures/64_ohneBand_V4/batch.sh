...
cd /home/nf838244/IEHK/DAMASK3/Biegesimulationen/64_ohneBand_V4
singularity exec /rwthfs/rz/SW/UTIL.common/singularity/damask-grid mpiexec -n 16 DAMASK_grid --load load.yaml --geom grid.vti
